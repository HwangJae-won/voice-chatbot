...
def inference_tacotron1(text):
    TTS_CP = 'C:\/Study/TTS/TTS_tacotron1/ckpt/origincode/1/ckpt-400000.pt'  # pretrained CP location
    ...
    #make audio and play
    Audio_CP = 'C:\/Study/TTS/TTS_tacotron1/ckpt/origincode/2/ckpt-50000.pt'  # pretrained CP location
